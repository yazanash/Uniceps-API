...
namespace Uniceps.Entityframework.Migrations
{
    ...
    [Migration("20260820083737_AddIntIdToBodyMeasurement")]
    partial class AddIntIdToBodyMeasurement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.NutritionSystem.DietLog", b =>
                {
                    ...
                    b.Property<float>("Clories")
                        .HasColumnType("real");

                    b.Property<float>("Fats")
                        .HasColumnType("real");

                    b.Property<string>("IngreientName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<float>("Protien")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.Products.ProductFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.Products.UserStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.RoutineModelsV2.Equipment", b =>
                {
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.RoutineModelsV2.ExerciseV2", b =>
                {
                    b.Property<string>("ExerciseId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.RoutineModelsV2.MuscleGroupV2", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.RoutineModelsV2.MuscleHead", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.RoutineModelsV2.ExerciseV2", b =>
                {
                    b.HasOne("Uniceps.Entityframework.Models.RoutineModelsV2.Equipment", "Equipment")
                        .WithMany()
                        .HasForeignKey("EquipmentCode")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Uniceps.Entityframework.Models.RoutineModelsV2.MuscleGroupV2", "MuscleGroupV2")
                        .WithMany()
                        .HasForeignKey("MuscleGroupCode")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Uniceps.Entityframework.Models.RoutineModelsV2.MuscleHead", "MuscleHead")
                        .WithMany()
            ...
            modelBuilder.Entity("Uniceps.Entityframework.Models.RoutineModelsV2.MuscleHead", b =>
                {
                    b.HasOne("Uniceps.Entityframework.Models.RoutineModelsV2.MuscleGroupV2", "Group")
                        .WithMany("Heads")
                        .HasForeignKey("MuscleGroupCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
